...
def apply_season_weights(matches: List[MatchData], current_season: int) -> List[MatchData]:
    """
    ...
    for match in matches:
        ...
        # Exponential decay: current season = 1.0, last season = 0.7, 2 seasons ago = 0.5
        match.weight = 0.7 ** years_ago
