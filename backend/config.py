...
class ModelConfig:
    ...
    DEFAULT_SIMULATIONS: int = 10000   # Number of season simulations (10,000 x 10,000 = 100M total)
    QUICK_SIMULATIONS: int = 1001      # For counterfactuals (quick single-run sims)
